...
def test_user_creation(snowflake_cursor, test_credentials, test_values, skip_user):
    """
    ...
    assert test_user in [
        ...
        for user in inspect_object_type("user", skip_user)
    ]


def test_user_removal(snowflake_cursor, test_credentials, test_values, skip_user):
    """
